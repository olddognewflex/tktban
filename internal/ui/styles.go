...
func newStyles(t theme) styles {
	return styles{
		...
		card:          lipgloss.NewStyle().Border(lipgloss.ThickBorder(), false, false, false, true).BorderForeground(t.surface).PaddingLeft(1),
		cardSelected:  lipgloss.NewStyle().Border(lipgloss.ThickBorder(), false, false, false, true).BorderForeground(t.accent).PaddingLeft(1),
